          ...
          <Card className="border-2 border-gray-200 hover:border-orange-400 hover:shadow-lg transition-all duration-300">
            ...
            <CardFooter>
              <Button 
                ...
                asChild
              >
                <a href="https://hozit.co.za/whmcs/index.php?rp=/store/web-development/basic-package" target="_blank" rel="noopener noreferrer">
                  Order Now
                </a>
              </Button>
            </CardFooter>
          ...
          <Card className="border-2 border-orange-400 shadow-lg relative">
            ...
            <CardFooter>
              <Button 
                ...
                asChild
              >
                <a href="https://hozit.co.za/whmcs/index.php?rp=/store/web-development/standard-package" target="_blank" rel="noopener noreferrer">
                  Order Now
                </a>
              </Button>
            </CardFooter>
          ...
          <Card className="border-2 border-gray-200 hover:border-orange-400 hover:shadow-lg transition-all duration-300">
            ...
            <CardFooter>
              <Button 
                ...
                asChild
              >
                <a href="https://hozit.co.za/whmcs/index.php?rp=/store/web-development/premium-package" target="_blank" rel="noopener noreferrer">
                  Order Now
                </a>
              </Button>
            </CardFooter>
