        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight text-white">
              Domain Registration and <span className="text-black">Website Hosting</span>
            </h1>
          ...
          <div className="hidden md:block">
            <div className="bg-white p-8 rounded-lg shadow-xl transform rotate-2 animate-fade-in border border-gray-200">
              <h3 className="text-xl font-bold text-black mb-4">Hosting Benefits</h3>
              <ul className="space-y-3">
                ...
                <li className="flex items-start">
                  ...
                  <span className="text-gray-700">Easy Website Management</span>
                </li>
              </ul>
